...
export default function MenuPage() {
  ...
  const [newAddOn, setNewAddOn] = useState({ name: "", price: "", allowQuantity: false })
        ...
        <div className="flex items-center justify-between gap-4 mb-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground">Add, edit, and manage your cafe menu items</p>
            </div>
          </div>
          <ThemeToggle />
        </div>
                  ...
                  <div className="grid gap-2">
                    ...
                    <div className="space-y-2 p-3 border rounded-lg bg-muted/50">
                        ...
                        <div className="flex items-center space-x-2">
                          <Checkbox
                            ...
                            onCheckedChange={(checked) =>
                              setNewAddOn({ ...newAddOn, allowQuantity: checked as boolean })
                            }
                          />
                      ...
                      <p className="text-xs text-muted-foreground">
                        Check "Allow quantity selection" for add-ons like eggs, where customers can specify amounts
                      </p>
                    </div>
                  </div>
                </div>
